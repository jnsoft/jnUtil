...
{
    public static string ToBinaryString(this byte[] bytes, bool LSBfirst = false, bool groupBytes = false, bool trim = false)
    {
    ...
    // pad: 101 -> 00000101
    public static byte[] ToByteArray(this BitArray bits, bool pad = true)
    {
